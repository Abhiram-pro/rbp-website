    ...
    <div className="pt-[100px] relative bg-[#111111] text-gray-300 min-h-screen flex flex-col overflow-x-hidden">
        ...
        >
            <nav className="flex justify-between items-center max-w-screen-xl mx-auto h-[70px]">
                <div className="flex items-center flex-shrink-0">
                    <img src="/logo.png" alt="RBP Lab logo" className="h-10 w-auto" />
                    <span className="text-xl font-bold text-white ml-2">RBP Lab</span>
                </div>
                ...
                {isMobileMenuOpen && (
                    ...
                    >
                        <div className="flex flex-col items-center space-y-4 px-6">
                            ...
                            <NavLink href="/members" onClick={() => setIsMobileMenuOpen(false)}>Members</NavLink>
                            <NavLink href="/publications" onClick={() => setIsMobileMenuOpen(false)}>Publications</NavLink>
                            <NavLink href="/news" onClick={() => setIsMobileMenuOpen(false)}>News</NavLink>
                            <NavLink href="/equipment" onClick={() => setIsMobileMenuOpen(false)}>Equipment</NavLink>
                            <NavLink href="/collaborators" onClick={() => setIsMobileMenuOpen(false)}>Collaborators</NavLink>
        ...
        <main className="flex-grow flex flex-col items-center justify-center text-center px-4 pt-8 pb-16 relative z-10">
            ...
            <motion.div
                ...
                className="mb-6"
            >
                <ShinyText text="Dept. of Biosciences & Bioengineering · IIT Guwahati" className="bg-[#1a1a1a] border border-gray-700 text-[#0CF2A0] px-4 py-1 rounded-full text-xs sm:text-sm font-medium cursor-default hover:border-[#0CF2A0]/50 transition-colors" />
            </motion.div>
            ...
            >
                ...
                <span className="inline-block h-[1.2em] sm:h-[1.2em] lg:h-[1.2em] overflow-hidden align-bottom">
                    <RotatingText
                        texts={['Laboratory', 'NMD Biology', 'Splicing', 'Gene Expression', 'EJC Research']}
            ...
            >
                Investigating the molecular logic of RNA-binding proteins in nonsense-mediated decay, splicing regulation, and gene expression fidelity.
            </motion.p>
            ...
            >
                <motion.a
                    href="/research"
                    className="w-full sm:w-auto bg-[#0CF2A0] text-[#111111] px-6 py-2 rounded-md text-sm font-semibold hover:bg-opacity-90 transition-colors duration-200 whitespace-nowrap shadow-sm hover:shadow-md text-center"
                    whileHover={{ scale: 1.03, y: -1 }}
                    whileTap={{ scale: 0.97 }}
                    transition={{ type: "spring", stiffness: 400, damping: 15 }}
                >
                ...
                <motion.a
                    href="/members"
                    className="w-full sm:w-auto border border-gray-600 text-gray-300 hover:text-white hover:border-gray-400 px-6 py-2 rounded-md text-sm font-semibold transition-colors duration-200 whitespace-nowrap text-center"
                    whileHover={{ scale: 1.03, y: -1 }}
                    whileTap={{ scale: 0.97 }}
                    transition={{ type: "spring", stiffness: 400, damping: 15 }}
                >
            ...
            >
                <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-4 text-center">
                    <div className="flex flex-col items-center">
                        ...
                        <span className="text-xs uppercase text-gray-500 tracking-wider mt-1">Publications</span>
                    </div>
                    <div className="w-px h-10 bg-gray-700 hidden sm:block" />
                    <div className="flex flex-col items-center">
                        <span className="text-3xl font-bold text-white">4</span>
                        <span className="text-xs uppercase text-gray-500 tracking-wider mt-1">Research Areas</span>
                    </div>
                    <div className="w-px h-10 bg-gray-700 hidden sm:block" />
                    <div className="flex flex-col items-center">
                        <span className="text-3xl font-bold text-[#0CF2A0]">IIT-G</span>
                        <span className="text-xs uppercase text-gray-500 tracking-wider mt-1">Institution</span>
                    </div>
                </div>
            </motion.div>
            ...
            >
                <div className="relative overflow-hidden rounded-lg border border-gray-700/50 bg-[#1a1a1a] py-4">
                    ...
                    <div style={{ display: 'flex', animation: 'ticker-scroll 40s linear infinite', width: 'max-content' }}>
                        {[
                            "New paper in BBA – Gene Regulatory Mechanisms: MAGOH/MAGOHB proteomics (Rehman A et al., 2026)",
                            "CRISPR-based MAGOH/MAGOHB paralog strategy published. GENE REPORTS (2025)",
                            "Discovery of MAGOH-delta37 — novel EJC-independent isoform. BBRC (2025)",
                            "BioID Proximity Mapping reveals novel SAP18 interactions. BBRC (2024)",
                            "miRNA-mediated regulation of NMD factors reviewed. BBA (2024)",
                        ].concat([
                            "New paper in BBA – Gene Regulatory Mechanisms: MAGOH/MAGOHB proteomics (Rehman A et al., 2026)",
                            "CRISPR-based MAGOH/MAGOHB paralog strategy published. GENE REPORTS (2025)",
                            "Discovery of MAGOH-delta37 — novel EJC-independent isoform. BBRC (2025)",
                            ...
                            <span key={i} className="inline-flex items-center gap-3 px-8 text-sm text-gray-400 whitespace-nowrap">
                                <span className="w-1.5 h-1.5 rounded-full bg-[#0CF2A0] flex-shrink-0" />
                                {item}
                            </span>
                        ))}
                    </div>
